...
export default function PrivacyPage() {
  return (
    <LegalPageLayout title="隐私政策" lastUpdated="2023年10月1日">
      <p>
        欢迎访问茶韵（Tea Culture Hub）。我们非常重视您的隐私保护。本隐私政策旨在向您说明我们如何收集、使用、存储和保护您的个人信息。
      </p>

      <h3>1. 信息收集</h3>
      <p>
        我们在您使用本网站时可能会收集以下类型的信息：
      </p>
      <ul>
        <li><strong>个人身份信息：</strong> 当您订阅我们的周刊或通过联系表单与我们联系时，我们可能会收集您的姓名、电子邮件地址等信息。</li>
        <li><strong>浏览数据：</strong> 我们可能会收集有关您如何访问和使用本网站的非个人身份信息，例如您的 IP 地址、浏览器类型、访问时间等。</li>
      </ul>
